...
BEGIN_MESSAGE_MAP(CBarTsApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBarTsApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CBarTsApp::CBarTsApp() noexcept
{
	...
	SetAppID(_T("BarTs.AppID.NoVersion"));
...
BOOL CBarTsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBarTsDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CBarTsView));
	if (!pDocTemplate)
		return FALSE;
